...
private:
  ...
  struct SnapSyncStat {
    ...
    struct SyncStat {
      ...
      SyncStat()
          : rfiles(0), rbytes(0), files_in_flight(0), files_deleted(0),
            large_files_in_flight(0), large_files_deleted(0),
            file_bytes_synced(0), dir_created(0), dir_deleted(0),
            dir_scanned(0) {
  ...
  void do_dir_sync(const std::string &dir_root, const std::string &cur_path,
                   ...
                   std::condition_variable &cv, const FHandles &fh,
                   std::atomic<bool> &canceled, std::atomic<bool> &failed,
                   SnapSyncStat &dir_sync_stat);
